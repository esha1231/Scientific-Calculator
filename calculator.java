...
public class calculator {
	...
	private void initialize() {
		...
		JButton btnNewButton_20_1 = new JButton("1/x");
		btnNewButton_20_1.setEnabled(false);
		...
		btnNewButton_20_1.setFont(new Font("Tahoma", Font.PLAIN, 17));
		btnNewButton_20_1.setBounds(10, 251, 64, 37);
		...
		rdbtnNewRadioButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				btnNewButton_20_1.setEnabled(true);
		...
		rdbtnOff.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Component btnRoot = null;
				btnRoot.setEnabled(false);
				
				
				Component btnNewButton_20_1 = null;
				btnNewButton_20_1.setEnabled(false);
				textField.setEnabled(false);
